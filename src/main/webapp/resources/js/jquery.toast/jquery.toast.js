(function($){
	var th = null, cf = null, toast = function(m,w,o){
		// fix option type info
		
		o = $.extend({ duration: 3000, sticky: false, 'type': 'info'}, o);
		typeof o.duration === 'number' || (o.duration = 3000);
		typeof o.sticky === 'boolean' || (o.sticky = false);
		typeof o.type === 'string' || (o.type = 'info');
	...
	toast.config = { width: 200, align: 'center', closeForStickyOnly: true };
	$.extend({ toast: toast });
})(jQuery);