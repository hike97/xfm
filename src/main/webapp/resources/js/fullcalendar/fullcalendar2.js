...
var BasicView = fcViews.basic = View.extend({
	...
	numberCellHtml: function(cell) {
		...
		return '' +
			'<td class="' + classes.join(' ') + '" data-date="' + date.format() + '">' +'<span date="' + date.format('YYYY-MM-DD') + '"class="fa fa-plus" style="display:none;float:left;"/>'+
			'<span date="' + date.format('YYYY-MM-DD') + '" class="fa fa-table" style="display:none;margin-left:20px;float:left"/>'+date.date() +
			'</td>';
	},
